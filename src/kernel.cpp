	...
	const COutPoint& prevout, unsigned int& nTimeTx, unsigned int nHashDrift, bool fCheck, uint256& hashProofOfStake, bool fPrintProofOfStake)
{
	...
	printf("CheckStakeKernelHash() : aa\n");

	printf("CheckStakeKernelHash() : fCheck = [%d] fPrintProofOfStake=[%d] using modifier 0x%016"PRIx64" at height=%d timestamp=%s for block from height=%d timestamp=%s\n",
				fCheck, fPrintProofOfStake, nStakeModifier, nStakeModifierHeight, 
	...
	printf("CheckStakeKernelHash() : cc=%d\n", fSuccess);
